...
export class InitialSchema1621082860495 implements MigrationInterface {
    name = 'InitialSchema1621082860495'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "create_question"."question" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "text" character varying(10000) NOT NULL, "date_created" TIMESTAMP NOT NULL DEFAULT now(), "sum_answers" integer NOT NULL DEFAULT 0, CONSTRAINT "PK_60feba564d25f5581606258e1ef" PRIMARY KEY ("id"))`);
