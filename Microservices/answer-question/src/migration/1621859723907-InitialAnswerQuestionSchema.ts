...
export class InitialAnswerQuestionSchema1621859723907 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "question" ("id" SERIAL NOT NULL, CONSTRAINT "PK_c3d19a72538eb388759ee112b54" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "answer" ("id" SERIAL NOT NULL, "text" text NOT NULL, "date_created" TIMESTAMP NOT NULL DEFAULT now(), "Userid" integer NOT NULL, "questionId" integer, CONSTRAINT "PK_c83eb039005df898a9fd9ce7b6b" PRIMARY KEY ("id"))`);
