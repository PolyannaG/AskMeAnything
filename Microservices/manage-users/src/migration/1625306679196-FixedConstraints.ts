...
export class FixedConstraints1625306679196 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "UQ_c2de56011e7a565cdd9ab8fa7c8" UNIQUE ("username")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "UQ_c2de56011e7a565cdd9ab8fa7c8"`);
    }
