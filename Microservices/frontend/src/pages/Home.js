...
function Home(){
    ...
    const getQuestionsPerDay=async()=>{
        let resp= await fetch(`https://statisticsmsapp.herokuapp.com/statistics/per_day/questions`,{
            method: 'GET',
    ...
    const getAnswersPerDay=async()=>{
        let resp= await fetch(`https://statisticsmsapp.herokuapp.com/statistics/per_day/answers`,{
            method: 'GET',
            headers: {'Content-type': 'application/json', 'x-access-token':tok},
            credentials: 'include'
        })
    ...
    const getData= async ()=>{
        let resp= await fetch(`https://statisticsmsapp.herokuapp.com/statistics/keywords`,{
            method: 'GET',
            headers: {'Content-type': 'application/json', 'x-access-token':tok},
            credentials: 'include'
        })
            ...
            if (dateFrom!==undefined && dateTo!==undefined){   //keyword and enddate, startdate
                ...
                try {
                    ...
                    if (lastDate.length===0)
                        ...
                        date=lastDate
                    console.log(date)
                    let resp = await fetch(`https://viewquestionmsapp.herokuapp.com/view_question/keyword_date_from_to/${selectedKeywords.label}/${date}/${dateTo}`,{
                        method: 'GET',
                        headers: {'Content-type': 'application/json', 'x-access-token':tok},
                        credentials: 'include'
                    })
                ...
                try {
                    ...
                    if (lastDate.length===0)
                        ...
                        date=lastDate
                    console.log(date)
                    let resp = await fetch(`https://viewquestionmsapp.herokuapp.com/view_question/keyword_date/${selectedKeywords.label}/${date}`,{
                        method: 'GET',
                        headers: {'Content-type': 'application/json', 'x-access-token':tok},
                        credentials: 'include'
                    })
            ...
            if (dateFrom!==undefined && dateTo!==undefined){   //enddate, startdate
                try {
                    ...
                    if (lastDate.length===0)
                        ...
                        date=lastDate
                    console.log(date)
                    let resp = await fetch(`https://viewquestionmsapp.herokuapp.com/view_question/start_end_date/${date}/${dateTo}`,{
                        method: 'GET',
                        headers: {'Content-type': 'application/json', 'x-access-token':tok},
                        credentials: 'include'
                    })
                ...
                try {
                    ...
                    if (lastDate.length===0)
                       date = new Date(dateFrom).toISOString()
                        ...
                        date=lastDate
                    console.log(date)
                    let resp = await fetch(`https://viewquestionmsapp.herokuapp.com/view_question/all/${date}`,{
                        method: 'GET',
                        headers: {'Content-type': 'application/json', 'x-access-token':tok},
                        credentials: 'include'
                    })
    ...
    const loadOptions=async (value)=>{
        ...
        if (value) {  //will fetch some keywords based on search
            ...
            let resp = await fetch(`https://viewquestionmsapp.herokuapp.com/view_question/specific_keywords/${value}`,{
                method: 'GET',
                headers: {'Content-type': 'application/json', 'x-access-token':tok},
                credentials: 'include'
            })
