...
export class QuestionService {
    ...
    async create(createQuestionDto: object) : Promise<Object>{
        let created_question = await this.httpService.post("https://datalayersoaapp.herokuapp.com/question/create", createQuestionDto)
    ...
    async findAll(date_from: Date): Promise<Object[]> {
        const questions = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findAll/"+date_from)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async findAllTitles(): Promise<Object[]> {
        const titles = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findAllTitles")
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async findAllUser(date_from: Date, Userid: number): Promise<Object[]> {
        const questions = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findAllUser/"+date_from+"/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async findOne(id: number): Promise<Object[]> {
        const question = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findOne/"+id)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async getMostPopular(): Promise<Object[]> {
        const questions = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/getMostPopular")
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async filterByStartAndEndDate(date_from: Date, date_to: Date): Promise<Object[]> {
        const questions = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/filterByStartAndEndDate/"+date_from+"/"+date_to)
            .pipe(map(response => response.data))
            .toPromise();
        ...
        for (let i = 0; i < questions.length; i++) {
            let keyw = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findOne/"+questions[i].id)
                .pipe(map(response => response.data))
                .toPromise();
    ...
    async filterByStartAndEndDateUser(date_from: Date, date_to: Date, Userid : number): Promise<Object[]> {
        const questions = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/filterByStartAndEndDateUser/"+date_from+"/"+date_to+"/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async filterByKeywordDateFrom(keyword: String, date_from: Date): Promise<Object[]> {
        const quest= await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/filterByKeywordDateFrom/"+keyword+"/"+date_from)
            .pipe(map(response => response.data))
            .toPromise();
        ...
        for (let i = 0; i < quest.length; i++) {
            let keyw = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findOne/"+quest[i].id)
                .pipe(map(response => response.data))
                .toPromise();
    ...
    async filterByKeywordDateFromUser(keyword: String, date_from: Date, Userid : number): Promise<Object[]> {
        const quest= await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/filterByKeywordDateFromUser/"+keyword+"/"+date_from+"/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async filterByKeywordDateFromTo(keyword: String, date_from: Date, date_to : Date): Promise<Object[]> {
        const quest= await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/filterByKeywordDateFromTo/"+keyword+"/"+date_from+"/"+date_to)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async filterByKeywordDateFromToUser(keyword: String, date_from: Date,  date_to : Date, Userid : number): Promise<Object[]> {
        const quest= await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/filterByKeywordDateFromToUser/"+keyword+"/"+date_from+"/"+date_to+"/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async findAllKeywords(): Promise<Object[]>{
        const keyw = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findAllKeywords")
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async findSpecificKeywords(keyword: String): Promise<Object[]>{
        const keyw = await this.httpService.get("https://datalayersoaapp.herokuapp.com/question/findSpecificKeywords/"+keyword)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async Subscribe(): Promise<any> {
        let body = {
            name : "Questions",
            address : "https://userinteractionsoaapp.herokuapp.com/user_interaction/question",
