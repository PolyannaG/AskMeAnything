...
export class StatsService {
    ...
    async findByKeywords(): Promise<Object[]> {
      const quest = await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/findByKeywords")
    ...
    async findByKeywordsUser(Userid: number): Promise<Object[]> {
        ...
        const quest= await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/findByKeywordsUser/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async showQuestionsPerDay(): Promise<Object[]> {
        ...
        const quest = await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/showQuestionsPerDay")
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async showQuestionsPerDayUser(Userid:number) : Promise<Object[]>{
        const quest = await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/showQuestionsPerDayUser/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async showAnswersPerDay() : Promise<Object[]>{
        const ans = await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/showAnswersPerDay")
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async showAnswersPerDayUser(Userid: number): Promise<Object[]> {
        const quest = await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/showAnswersPerDayUser/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async countAnswersUser(Userid: number): Promise<Object[]>{
        const quest = await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/countAnswersUser/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async countQuestionsUser(Userid: number): Promise<Object[]>{
        const quest = await this.httpService.get("https://datalayersoaapp.herokuapp.com/statistics/countQuestionsUser/"+Userid)
            .pipe(map(response => response.data))
            .toPromise();
    ...
    async Subscribe(): Promise<any> {
        let body = {
            name : "Statistics",
            address : "http://statisticssoaapp/stats",
    ...
    async unSubscribe(): Promise<any> {
        let body = {
            name : "Statistics",
            address : "https://statisticssoaapp.herokuapp.com/stats",
            description : "Returns data about Questions or/and Answers or/and Keywords or/and Users for statistic analysis",
            services : []
        };
